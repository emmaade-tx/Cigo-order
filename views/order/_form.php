...
<form id="myForm" class="needs-validation pt-3" novalidate autocomplete="off">
    ...
    <div class="row">
        ...
        <input name="phone_number" value="" type="number" pattern='^\+?\d{0,13}' class="form-control" placeholder="+1 (888) 892-1321" required>
        ...
        <div class="input-group">
            ...
            <input name="order_value" value="" type="number" class="form-control" placeholder="Amount">
        </div>
        </div>
        </div>
        <div class="col-12 col-md-6 col-lg-6">
        ...
        <label for="">Scheduled Date <span class="red">*</span></label>
            ...
            <div class="input-group date">
                ...
                <input name="scheduled_date" type="text" class="form-control" placeholder="dd/mm/yyyy" required><span class="input-group-addon"></span>
                <div class="invalid-feedback">
    ...
    <div class="row">
        <div class="col-6 col-sm-6 col-lg-6">
            <button id="previewLocation" type="button" class="btn btn-sm btn-gray-outline">Preview Location</button>
        </div>
        <div class="col-6 col-sm-6 col-lg-6 text-right">
            ...
            <input id="formReset" type="reset" value="Cancel"  class="btn btn-sm btn-gray"/>
        </div>
    </div>
    </div>
</form>